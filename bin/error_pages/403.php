...
<html>
	<head>
		<title>CptnH00k - Not authenticated</title>
		<style>
			body, html {
				margin: 0;
				padding: 0;
	...
	<body>
		<div class="wrapper">
			<h1 class="sfheader">CptnH00k <small>//Authentication error</small></h1>
		</div>
		<div class="errormsg">
			<div class="wrapper">
				<h1><?= $code ?>: <?= $message ?></h1>
				<p><?=$message?></p>
				<p><a href="<?= url('user', 'login', ['returnto' => (string)url('listener', 'register')->absolute()]) ?>">Click here</a> to log in and proceed</p>
			</div>
		</div>
